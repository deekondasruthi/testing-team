...
<<<<<<< HEAD
    ...
    public String getText(WebElement ele) {
		try {
	        // Attempt to get the text of the WebElement
	        return ele.getText();
	    } catch (Exception e) {
	        // Log the exception (if you have a logger) and return the error message
	        System.err.println("Error while retrieving text from WebElement: " + e.getMessage());
